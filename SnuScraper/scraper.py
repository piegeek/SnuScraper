    ...
    def update_db(self, debug_data = None):
        ...
        for data in updated_nums_data:
            ...
            if updated_num < max_student_num and is_full == True:
                self.log_message(f'1, title: {lecture['교과목명']}, updated_num: {updated_num}, max_student_num: {max_student_num}')
               ...
               self.log_message(f'2, title: {lecture['교과목명']}, updated_num: {updated_num}, max_student_num: {max_student_num}')
               new_values = {'$set': { '수강신청인원': updated_num, 'isFull': True }}
            
            else:
                self.log_message(f'3, title: {lecture['교과목명']}, updated_num: {updated_num}, max_student_num: {max_student_num}')
